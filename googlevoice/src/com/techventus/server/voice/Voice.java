...
public class Voice {
  ...
  final static String voicemailDownloadURLString = "https://www.google.com/voice/media/send_voicemail/";
	...
	public Voice(String user, String pass, String source) throws IOException {
		init(user, pass, source, true, GOOGLE, null, null, null);
	...
	public Voice(String user, String pass) throws IOException {
		init(user, pass, null, true, GOOGLE, null, null, null);
	}

    public Voice(String user, String authToken, boolean googleAcctTypeOnly) throws IOException {
        init(user, "", null, true, googleAcctTypeOnly ? GOOGLE : HOSTED_OR_GOOGLE, null, null, authToken);
    }
	...
	public Voice(String user, String pass, String source,
		...
		init(user, pass, source, printDebugIntoToSystemOut, GOOGLE, null, null, null);
	}
	...
	public Voice(String user, String pass, String source,
		...
		init(user, pass, source, printDebugIntoToSystemOut, accountType, null, null, null);
	}
	...
	public Voice(String user, String pass, String source,
		...
		init(user, pass, source, printDebugIntoToSystemOut, accountType, captchaResponse, captchaToken, null);
	}
	...
	private void init(String user, String pass, String source,
                      boolean printDebugIntoToSystemOut, String accountType, String captchaResponse, String captchaToken, String authToken) throws IOException {
...
//		}
    ...
    private void updateUserPhoneInfo() throws IOException {
